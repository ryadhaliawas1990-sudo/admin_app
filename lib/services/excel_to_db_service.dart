...
class _HrScreenState extends State<HrScreen> {
  ...
  String safeText(dynamic v) => v?.toString() ?? '';
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              const Text("📥 استيراد كشوفات الأفراد"),
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        subtitle: Text("الوحدة: ${item['unit']} | الحالة: ${item['status']}"),
                      ),
                    );
                  },
                ),
  ...
  Future<void> _generateFilteredReport() async {
    ...
    for (var e in records) {
      sheet.appendRow([
        TextCellValue(safeText(e['number'])),
        TextCellValue(safeText(e['rank'])),
        TextCellValue(safeText(e['name'])),
        TextCellValue(safeText(e['unit'])),
        TextCellValue(safeText(e['status'])),
        TextCellValue(safeText(e['month'])),
        TextCellValue(safeText(e['year'])),
      ]);
    }
